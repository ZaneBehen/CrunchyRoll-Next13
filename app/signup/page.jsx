...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    return (
      ...
      <div>
        <h1 className="flex justify-center pt-40 text-3xl mb-6">
          Create Account
        </h1>
        ...
        <p className="text-gray-500 text-center text-xs mt-2">
          ...
          <span className="text-black">our Terms & Privacy Policy</span>,
        </p>
        ...
        <p className="text-lg text-center mt-4">
          ...
          <Link href="/login">
            <span className="text-orange-500 cursor-pointer"> Log In</span>
          </Link>
        </p>
      </div>
    </div>
